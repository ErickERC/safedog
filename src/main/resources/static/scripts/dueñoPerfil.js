  ...
  fetch(urlPerrito, {
    ...
    .then((data) => {
      ...
      const generoRadio = document.querySelector(
        `input[name="genero"][value="${perritoData.genero}"]`
      );
      if (generoRadio) {
      ...
      const tamanioRadio = document.querySelector(
        `input[name="tamanios"][value="${perritoData.tamanio}"]`
      );
      if (tamanioRadio) {
